        ...
        <div data-aos="zoom-in" className="grid md:grid-cols-4 pb-44 pt-5">
          <div className="py-8 px-4">
            ...
            <p>
              ...
              aspernatur quasi delectus suscipit. Beatae doloremque tenetur
              magnam enim sunt? Quis numquam fugiat aperiam omnis hic
              consectetur, ipsam, nostrum nesciunt dolor, tempore dolorum.
            </p>
          </div>
          <div className="ml-8">
            <div className="py-8 px-4">
