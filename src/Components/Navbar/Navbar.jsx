  ...
  return (
    <div className="shadow-md bg-white dark:text-white duration-200 relative z-40">
      ...
      <div data-aos="zoom-in" className="flex justify-center">
        <ul className="sm:flex text-primary/60 items-center gap-4">
            {Menu.map((data) => {
                return(
                    <li key={data.id}>
            ...
            <li className="group relative cursor-pointer">
                ...
                <div className="absolute z-[9999] hidden group-hover:block w-[200px] rounded-md bg-white p-2 text-primary shadow-md">
                    <ul>
